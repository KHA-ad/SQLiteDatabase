...
//定义选择菜单
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        getMenuInflater().inflate(R.menu.menu_wordlistview, menu);
    }
    ...
    private ArrayList<Map<String,String>> getAll() {
        ...
        String sort= Words.Word.COLUMN_NAME_WORD +" DESC";
        Cursor c=db.query(Words.Word.TABLE_NAME,projection,null,null,null,null,sort);
    ...
    private void SearchDialog() {
        final TableLayout tableLayout = (TableLayout) getLayoutInflater().inflate(R.layout.searchitem, null);
        new AlertDialog.Builder(this)
        .setTitle("查找单词")//标题
                .setView(tableLayout)//设置视图
                //确定按钮及其动作
